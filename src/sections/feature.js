...
// object data specifying that qualities of the product
// keep it short and precise for aesthetic purposes
//do not exceed 4 qualities limit else looks messy
const data = [
  {
    id: 1,
    imgSrc: Performance,
